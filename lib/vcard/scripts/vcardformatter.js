...
/// <reference path="../../../lib/moment/scripts/moment.js" />
...
(function () {
    ...
    function (_Global) {
        ...
        WinJS.Namespace.define("VCard", {
             ...
             */
            VCardFormatter: WinJS.Class.define(function VCardFormatter_ctor() {
                Log.call(Log.l.trace, "VCard.");
                Log.ret(Log.l.trace);
            }, {
                /**
                ...
                getFormattedString: function (vCard) {
                    ...
                    var majorVersion = vCard.getMajorVersion();
                    ...
                    if (vCard.logo.url) {
                        formattedVCardString += getFormattedPhoto('LOGO',
                            vCard.logo.url,
                    ...
                    if (vCard.photo.url) {
                        formattedVCardString += getFormattedPhoto('PHOTO',
                            vCard.photo.url,

...
/// <reference path="../../../lib/vcard/scripts/vcardformatter.js" />
...
(function () {
    ...
    WinJS.Namespace.define("VCard", {
         ...
         */
        VCard: WinJS.Class.define(function VCard_ctor() {
            ...
            getMajorVersion: function () {
                var majorVersionString = this.version ? this.version.split('.')[0] : '3';
            ...
            getFormattedString: function () {
                var vCardFormatter = new VCard.VCardFormatter();

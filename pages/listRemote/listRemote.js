...
/// <reference path="~/www/pages/listRemote/listRemoteController.js" />
(function () {
    "use strict";

    WinJS.Namespace.define("Application.ListRemoteLayout", {
        ...
        },
        {
            ...
            initialize: function (site) {
                ...
                WinJS.Utilities.addClass(this._surface, "listRemoteLayout");
            ...
            uninitialize: function () {
                WinJS.Utilities.removeClass(this._surface, "listRemoteLayout");
                this._site = null;
                this._surface = null;
            }
        })
    ...
    var pageName = Application.getPagePath("listRemote");
                    ...
                    if (listRemoteContacts && listRemoteContacts.style) {
                        ...
                        if (contentarea) {
                            ...
                            if (height !== that.prevHeight) {
                                ...
                                listRemoteContacts.style.height = height.toString() + "px";
                            }
                        }
                    }
                    that.inResize = 0;

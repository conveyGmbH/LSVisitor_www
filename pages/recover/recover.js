...
/// <reference path="~/www/lib/convey/scripts/navigator.js" />
/// <reference path="~/www/pages/recover/recoverController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("recover");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function(element, options) {
            ...
            this.controller = new Recover.Controller(element, commandList);

...
/// <reference path="~/www/pages/photoRemote/photoRemoteService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("PhotoRemote", {
        Controller: WinJS.Class.derive(Application.Controller, function Controller(pageElement, commandList) {
            Log.call(Log.l.trace, "PhotoRemote.Controller.");
            ...
            var loadData = function () {
                ...
                var ret = new WinJS.Promise.as().then(function () {
                    if (!AppData._remotePhotoData) {
                        var importCardscanId = AppData.getRecordId("DOC1IMPORT_CARDSCAN_Remote");
                        if (importCardscanId) {

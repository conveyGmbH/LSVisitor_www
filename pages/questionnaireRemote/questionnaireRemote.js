...
/// <reference path="~/www/pages/questionnaireRemote/questionnaireRemoteController.js" />
(function () {
    "use strict";

    WinJS.Namespace.define("Application.QuestionnaireRemoteLayout", {
    ...
    var pageName = Application.getPagePath("questionnaireRemote");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new QuestionnaireRemote.Controller(element, commandList);
